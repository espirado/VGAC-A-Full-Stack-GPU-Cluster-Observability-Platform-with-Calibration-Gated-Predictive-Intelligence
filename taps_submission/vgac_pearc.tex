...
\keywords{GPU scheduling, calibration, decision rules, policy integration, Kubernetes, Slurm, observability}
...
\bibitem{espira2026reliability}
A.\ Espira.
\newblock Reliability SLIs and SLOs for GPU queue-delay prediction: A calibration-first framework.
\newblock Companion paper, 2026.

\bibitem{espira2026benchmark}
A.\ Espira, T.\ Dhole, and S.\ Kumar.
\newblock Calibration under extreme imbalance: A multi-cluster benchmark for operational queue-delay prediction.
\newblock TechRxiv, 2026.
\newblock DOI: 10.36227/techrxiv.177041829.96464119.

\bibitem{decima}
H.\ Mao et al.
\newblock Learning scheduling algorithms for data processing clusters.
\newblock In \emph{Proc.\ ACM SIGCOMM}, 2019, pp.\ 270--288.

\bibitem{guo2017calibration}
C.\ Guo, G.\ Pleiss, Y.\ Sun, and K.\ Q.\ Weinberger.
\newblock On calibration of modern neural networks.
\newblock In \emph{Proc.\ ICML}, 2017, pp.\ 1321--1330.

\bibitem{platt1999}
J.\ Platt.
\newblock Probabilistic outputs for support vector machines and comparisons to regularized likelihood methods.
\newblock \emph{Advances in Large Margin Classifiers}, vol.\ 10, no.\ 3, pp.\ 61--74, 1999.

\bibitem{borg}
A.\ Verma et al.
\newblock Large-scale cluster management at Google with Borg.
\newblock In \emph{Proc.\ EuroSys}, 2015, pp.\ 1--17.

\bibitem{firmament}
I.\ Gog et al.
\newblock Firmament: Fast, centralized cluster scheduling at scale.
\newblock In \emph{Proc.\ OSDI}, 2016, pp.\ 99--115.

\bibitem{elkan2001}
C.\ Elkan.
\newblock The foundations of cost-sensitive learning.
\newblock In \emph{Proc.\ IJCAI}, 2001, pp.\ 973--978.
